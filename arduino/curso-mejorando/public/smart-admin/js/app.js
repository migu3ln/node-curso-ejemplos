...
$(function() {
    $(document).ready(function() {
        $("#menu_principal").attr("style", function(i, val) {
            if (val == "overflow: hidden;")
            {
                val = "";
            }
            return val;
...
//		$(this).effect("highlight", {}, 500);
    ...
    $('#logout a').click(function(e) {
        ...
        // ask verification
        $.SmartMessageBox({
            title: "<i class='fa fa-sign-out txt-color-orangeDark'></i> Cerrar Sesión <span class='txt-color-orangeDark'><strong>",
            content: $.logoutMSG || "Desea cerrar Sesión?",
            buttons: '[No][Sí]'
